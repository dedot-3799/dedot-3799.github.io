...
async function classfyInsent(text) {
                ...
                for (let [key, regex] of Object.entries(regexes)) {
                    ...
                    if (match) {
                        ...
                        switch (key) {
                            ...
                            case 'primeCheck':
                                var t = parseFormulav2(removeZero(match[1]));
                                return isNaN(parseInt(t)) ? String(t) : responses[character].primeCheck(t, await isPrime(t));
                            case 'help': {
